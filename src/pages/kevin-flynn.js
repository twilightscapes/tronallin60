...
<h1 className="tronText" style={{display:'grid', placeContent:'center', textAlign:'center', fontSize:'14vw', position:'absolute', top:'0', marginTop:'', width:'100%', padding:'0 30%', opacity:'1', zIndex:'0'}}>
 ...
 <div id="characters" className="characters" style={{position:'relative', zIndex:'0', width:'100vw', height:'100vh', top:'0', background:'none', filter:'none', boxShadow:'none', padding:'15vh 0 0 0', overflow:'hidden', border:'0px solid blue'}}>
 ...
 <ReactPlayer
       ...
       >
          ...
          <Link state={{modal: true}} to="/enter-the-grid/" style={{color:'#37f8f8',  height:'100vh', width:'100vw', display:'grid', placeContent:'center', border:'0px solid yellow', position:'relative', top:'100vh'}}>
            <div className="" style={{
...
alt="Todd Lambert Web development for photographers" src="../../static/assets/kevin-flynn.png" />
    ...
    <div>
<h1 className="tronText" style={{paddingTop:'18vh', fontSize:'clamp(2rem, 3vw, 3rem)'}}>Kevin Flynn</h1>
