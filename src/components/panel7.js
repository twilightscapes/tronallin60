...
<button className="actionJackson TRON tronText" style={{display:'flex', justifyContent:'center', zIndex:'2', filter:'drop-shadow(2px 2px 2px #000)', width:'30vw', borderRadius:'200px',fontSize:'2vw', padding:'10% 5%', }}><Link state={{modal: true}} to="/the-grid/meet-quorra/" title="Quorra" style={{color:'#37f8f8'}}>Meet Quorra <span style={{fontSize:'150%'}}></span></Link></button>
